        ...
        >
          <div className="overflow-hidden position-relative h-100">
            ...
            <div className="slideshow-text container position-absolute start-50 top-50 translate-middle">
              <h6 className="text_dash text-uppercase text-red fs-base fw-medium animate animate_fade animate_btt animate_delay-3 text-white">
                {elm.text1}
              </h6>
              <h2 className="text-uppercase h1 fw-normal mb-0 animate animate_fade animate_btt animate_delay-5 text-white">
                {elm.text2}
              </h2>
              {elm.text3 ? (
                <h2 className="text-uppercase h1 fw-bold animate animate_fade animate_btt animate_delay-5 text-white">
                  {elm.text3}
                </h2>
              ) : (
                ""
              ...
              {elm.text4 ? (
                <h6 className="text-uppercase mb-5 animate animate_fade animate_btt animate_delay-3 text-white">
                  {elm.text4}
                </h6>
              ) : (
                ""
